...
showcaseRouter.put("/:id/items/remove", showcaseController.removeItemsFromShowcase);

// Update an item in a showcase
showcaseRouter.put("/items/:id", showcaseController.updateItemInShowcase);
